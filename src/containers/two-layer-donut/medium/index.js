                ...
                { 
                  this.state.leaveEqual === true ? (
                    <div style={{position : 'relative'}}> 
                        <Slice  slicedegree="0">
                            <Pie mainbg={this.props.bgclr} widthoffset="37" piebg={ this.props.paintShades.c1 } degree="360" />
                        </Slice>
                        <Slice clipnative slicedegree="180">
                            <Pie mainbg={this.props.bgclr} clipnative widthoffset="37" piebg={ this.props.paintShades.c2 } degree="360" />
                        </Slice>
                    </div>
                  ) :(
                <div className ="wrapper" style={{position : 'relative'}}>
                    <Slice piebg="yellow">
                        <Slice  slicedegree={ 0 - p1 } >
                            <Pie mainbg={this.props.bgclr} widthoffset="37" piebg={ this.props.paintShades.c1 } degree={ 360 + p1} />
                        </Slice> 
                        <Slice clipnative slicedegree={ 180 - p2 }  z_axis={p2}>
                            <Pie mainbg={this.props.bgclr} clipnative widthoffset="37" piebg={ this.props.paintShades.c2 } degree={ 360 + p2 } />
                        </Slice> 
                    </Slice>
                </div> 
                 )
