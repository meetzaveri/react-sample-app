             ...
             <Wrapper mainbg="white" >
                <div className ="wrapper" style={{position : 'relative'}}>
                    ...
                    {(progress > 180) ? (<div>
                        ...
                        <div>
                            <Slice  slicedegree={ 0 } >
                                <Pie mainbg={this.props.bgclr} widthoffset="60" piebg={ this.props.paintShades.c2 }  degree={ 0 } />
                            </Slice> 
                            <Slice clipnative slicedegree={ 180 }  z_axis={progress}>
                                <Pie mainbg={this.props.bgclr} clipnative widthoffset="60" piebg={ this.props.paintShades.c1 }  degree={ 180 + progress } />
                            </Slice> 
                        </div>
                    )}
