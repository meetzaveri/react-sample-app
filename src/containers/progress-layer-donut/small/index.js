...
class Circle extends Component{
    constructor(props){
        ...
        this.incProgress = this.incProgress.bind(this);
        this.decProgress = this.decProgress.bind(this);
             ...
             <Wrapper mainbg="white" >
                <div className ="wrapper" style={{position : 'relative'}}>
                    ...
                    {(progress > 180) ? (<div>
                        ...
                        <Slice  slicedegree={ 0 } >
                                <Pie mainbg={this.props.bgclr} widthoffset="88" piebg={ this.props.paintShades.c1 }  degree={ 0 } />
                            </Slice> 
                            <Slice clipnative slicedegree={ 0 }  z_axis={progress}>
                                <Pie mainbg={this.props.bgclr} clipnative widthoffset="88" piebg={ this.props.paintShades.c2 }  degree={ 180 + progress } />
                            </Slice> 
                    </div>) :(
                        <div>
                            <Slice  slicedegree={ 0 } >
                                <Pie mainbg={this.props.bgclr} widthoffset="88" piebg={ this.props.paintShades.c2 }  degree={ 0 } />
                            </Slice> 
                            <Slice clipnative slicedegree={ 180 }  z_axis={progress}>
                                <Pie mainbg={this.props.bgclr} clipnative widthoffset="88" piebg={ this.props.paintShades.c1 }  degree={ 180 + progress } />
                            </Slice> 
                        </div>
                    )}
                    </Slice>
                </div> 
                <DoughnutWrapper mainbg={this.props.bgclr} donutwidth="110" setpos="95" >
                    {this.state.value}
                </DoughnutWrapper>
            </Wrapper>
